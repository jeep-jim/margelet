...
export function FeedHeader({
  ...
  const COPY = {
    ...
    in: {
      title: "विषय और खोज",
      subtitle: "अपनी फ़ीड को निजी बनाने के लिए विषय चुनें।",
      searchPlaceholder: "चैनल, टेक्स्ट, लिंक से खोजें...",
      show: "दिखाएँ",
      found: "मिले",
      erase: "मिटाएँ",
    ...
    ir: {
      ...
      found: "یافت شد",
      erase: "پاک کردن",
      selectedTopics: "انتخاب‌شده",
      emptyTagState: "موضوعی انتخاب نشده",
    },
    tr: {
    ...
    kz: {
      ...
      found: "табылды",
      erase: "Тазалау",
      selectedTopics: "Таңдалды",
      emptyTagState: "Тақырыптар таңдалмаған",
    },
    uz: {
      title: "Mavzular va qidiruv",
      subtitle: "Lentani moslash uchun mavzularni tanlang.",
      searchPlaceholder: "Kanal, matn, havola bo‘yicha qidirish...",
      show: "Ko‘rsatish",
      found: "topildi",
      erase: "Tozalash",
      selectedTopics: "Tanlangan",
      emptyTagState: "Mavzular tanlanmagan",
    },
    ae: {
      title: "المواضيع والبحث",
      subtitle: "اختر المواضيع لتخصيص خلاصتك.",
      searchPlaceholder: "ابحث حسب القناة أو النص أو الرابط...",
      show: "عرض",
      found: "تم العثور",
      erase: "مسح",
      selectedTopics: "المحدد",
      emptyTagState: "لم يتم اختيار مواضيع",
    },
    eg: {
      title: "المواضيع والبحث",
      subtitle: "اختر المواضيع لتخصيص خلاصتك.",
    ...
    my: {
      ...
      erase: "Padam",
      selectedTopics: "Dipilih",
      emptyTagState: "Tiada topik dipilih",
    },
  } as const;

  const copy = COPY[locale] ?? COPY.us;
  const selectedCount = selectedTags.length;
  const canErase = selectedCount > 0 || searchQuery.trim().length > 0;
  const hasPendingChanges = selectedCount > 0 || searchQuery.trim().length > 0;
