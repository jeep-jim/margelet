...
const COPY = {
  ...
  uk: {
    ...
    audioFallback: "Аудіо",
    audioFromTelegram: "Аудіо з поста Telegram",
    fileFallback: "Файл",
    fileFromTelegram: "Вкладення з поста Telegram",
    openFile: "Відкрити файл",
    musicAvailable: "Музика доступна в оригінальному пості",
    musicAvailableText:
      "Тут показуємо картку поста. Оригінальний трек можна відкрити в Telegram.",
  ...
  in: {
    postFromTelegram: "Telegram post",
    enableNotifications: "Enable notifications",
    disableNotifications: "Disable notifications",
    audioFallback: "Audio",
    audioFromTelegram: "Audio from Telegram post",
  ...
  fa: {
    ...
    audioFallback: "صدا",
    audioFromTelegram: "صدا از پست Telegram",
    fileFallback: "فایل",
    fileFromTelegram: "پیوست از پست Telegram",
    openFile: "باز کردن فایل",
    musicAvailable: "موسیقی در پست اصلی موجود است",
    musicAvailableText:
      "اینجا کارت پست را نشان می‌دهیم. می‌توانید ترک اصلی را در Telegram باز کنید.",
    openInTelegram: "باز کردن در Telegram",
    play: "پخش",
    pause: "توقف",
    mute: "بی‌صدا",
    unmute: "با صدا",
  ...
  kk: {
    ...
    audioFallback: "Аудио",
    audioFromTelegram: "Telegram постындағы аудио",
    fileFallback: "Файл",
    fileFromTelegram: "Telegram постындағы тіркеме",
    openFile: "Файлды ашу",
    musicAvailable: "Музыка түпнұсқа постта қолжетімді",
    musicAvailableText:
      "Мұнда пост картасы көрсетіледі. Түпнұсқа тректі Telegram-да ашуға болады.",
    openInTelegram: "Telegram-да ашу",
    play: "Ойнату",
    pause: "Пауза",
    mute: "Дыбысты өшіру",
    unmute: "Дыбысты қосу",
  ...
  uz: {
    postFromTelegram: "Telegram posti",
    enableNotifications: "Bildirishnomalarni yoqish",
    disableNotifications: "Bildirishnomalarni o‘chirish",
    audioFallback: "Audio",
    audioFromTelegram: "Telegram postidagi audio",
    fileFallback: "Fayl",
    fileFromTelegram: "Telegram postidagi biriktirma",
    openFile: "Faylni ochish",
    musicAvailable: "Musiqa original postda mavjud",
    musicAvailableText:
      "Bu yerda post kartasini ko‘rsatamiz. Original trekni Telegram’da ochish mumkin.",
  ...
  ae: {
    postFromTelegram: "منشور من Telegram",
    enableNotifications: "تفعيل الإشعارات",
    disableNotifications: "إيقاف الإشعارات",
    audioFallback: "صوت",
    audioFromTelegram: "صوت من منشور Telegram",
    fileFallback: "ملف",
    fileFromTelegram: "مرفق من منشور Telegram",
    openFile: "فتح الملف",
    musicAvailable: "الموسيقى متاحة في المنشور الأصلي",
    musicAvailableText:
      "نعرض هنا بطاقة المنشور. يمكنك فتح المقطع الأصلي في Telegram.",
  ...
  mx: {
    postFromTelegram: "Post de Telegram",
    enableNotifications: "Activar notificaciones",
    disableNotifications: "Desactivar notificaciones",
    audioFallback: "Audio",
    audioFromTelegram: "Audio del post de Telegram",
    fileFallback: "Archivo",
    fileFromTelegram: "Adjunto del post de Telegram",
    openFile: "Abrir archivo",
    musicAvailable: "La música está disponible en el post original",
    musicAvailableText:
      "Aquí mostramos la tarjeta del post. Puedes abrir la pista original en Telegram.",
  ...
  zh: {
    ...
    audioFallback: "音频",
    audioFromTelegram: "来自 Telegram 帖子的音频",
    fileFallback: "文件",
  ...
  ms: {
    ...
    fileFromTelegram: "Lampiran dari post Telegram",
    openFile: "Buka fail",
    musicAvailable: "Muzik tersedia dalam post asal",
    musicAvailableText:
      "Di sini kami tunjukkan kad post. Trek asal boleh dibuka di Telegram.",
    openInTelegram: "Buka di Telegram",
    play: "Main",
    pause: "Jeda",
    mute: "Bisu",
