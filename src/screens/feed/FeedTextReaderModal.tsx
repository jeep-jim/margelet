...
export function FeedTextReaderModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/30 backdrop-blur-sm">
      <div className="mx-auto flex h-full w-full max-w-[720px] flex-col bg-white pt-16">
        <div className="sticky top-16 z-10 flex items-center justify-between border-b border-neutral-200 bg-white px-4 py-3">
          <button
            type="button"
            onClick={onClose}
