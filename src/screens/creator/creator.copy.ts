...
function withLanguageTitle(locale: Locale, copy: ScreenCopy): ScreenCopy {
  return {
    ...copy,
...
export const CREATOR_COPY: Record<Locale, ScreenCopy> = {
  ru: withLanguageTitle("ru", COPY_BASE.ru),
  uk: withLanguageTitle("uk", COPY_BASE.ru),
  en: withLanguageTitle("en", COPY_BASE.en),
  in: withLanguageTitle("in", COPY_BASE.en),
  fa: withLanguageTitle("fa", COPY_BASE.en),
  tr: withLanguageTitle("tr", COPY_BASE.tr),
  "pt-br": withLanguageTitle("pt-br", COPY_BASE["pt-br"]),
  kk: withLanguageTitle("kk", COPY_BASE.ru),
  uz: withLanguageTitle("uz", COPY_BASE.ru),
  ae: withLanguageTitle("ae", COPY_BASE.en),
  eg: withLanguageTitle("eg", COPY_BASE.en),
  pk: withLanguageTitle("pk", COPY_BASE.en),
  id: withLanguageTitle("id", COPY_BASE.id),
  mx: withLanguageTitle("mx", COPY_BASE.es),
  sa: withLanguageTitle("sa", COPY_BASE.en),
  es: withLanguageTitle("es", COPY_BASE.es),
  it: withLanguageTitle("it", COPY_BASE.it),
  fr: withLanguageTitle("fr", COPY_BASE.fr),
  de: withLanguageTitle("de", COPY_BASE.de),
  ar: withLanguageTitle("ar", COPY_BASE.es),
  co: withLanguageTitle("co", COPY_BASE.es),
  za: withLanguageTitle("za", COPY_BASE.en),
  ng: withLanguageTitle("ng", COPY_BASE.en),
  zh: withLanguageTitle("zh", COPY_BASE.en),
  ms: withLanguageTitle("ms", COPY_BASE.en),
};
