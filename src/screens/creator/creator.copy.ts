...
const COPY_BASE = {
  en: {
    ...
    channelPlaceholder: "https://t.me/your_channel / @channel / channel",
    channelButton: "Send request",
    channelEmptyError: "Paste a Telegram channel link first.",
    channelInvalidError: "Use https://t.me/channel_name, @channel_name or channel_name",
    channelSuccess:
