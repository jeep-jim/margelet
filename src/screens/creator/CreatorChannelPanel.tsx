...
function normalizeChannelUrl(value: string) {
  ...
  const directHandle = raw.replace(/^@+/, "");
  if (/^[A-Za-z0-9_]{4,}$/.test(directHandle)) {
    return {
      handle: directHandle,
      url: `https://t.me/${directHandle}`,
    };
  }
...
const CHANNEL_UI = {
  ru: {
    ...
    invalidError: "Use https://t.me/channel_name, @channel_name or channel_name",
