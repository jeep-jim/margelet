export function SpaceStyle() {
  return (
    <style>{`
      ...
      @keyframes spacePulse { 0%,100%{opacity:.035; transform:scale(.90)} 50%{opacity:.085; transform:scale(1.04)} }
      ...
      @keyframes spaceWave { 0%{opacity:.55; transform:translate(-50%,-50%) scale(.18)} 55%{opacity:.24} 100%{opacity:0; transform:translate(-50%,-50%) scale(3.35)} }
      @keyframes spaceMiniWave { 0%{opacity:.55; transform:scale(.55)} 100%{opacity:0; transform:scale(1.85)} }
