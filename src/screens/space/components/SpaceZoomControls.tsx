...
export function SpaceZoomControls({ theme, zoomIn, zoomOut }: Props) {
  ...
  const cls = `grid h-12 w-12 place-items-center rounded-full text-2xl font-black shadow-2xl backdrop-blur-xl transition active:scale-95 ${isLight ? "bg-white/76 text-[#07111d] hover:bg-white" : "bg-white/12 text-white hover:bg-white hover:text-[#07111d]"}`;
  return (
