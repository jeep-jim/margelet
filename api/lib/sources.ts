...
const MAX_IMPORT_CANDIDATES_PER_SOURCE = 3;
const MAX_REFRESH_POSTS_PER_SOURCE = 1;
const MAX_RESCUE_IMPORTS_PER_EMPTY_SOURCE = 1;
const COUNTRY_RESCUE_FRESH_POSTS_THRESHOLD = 2;

const POST_TTL_HOURS = 48;
const SOURCE_PAGE_TIMEOUT_MS = 10000;

const REFRESH_INTERVAL_MS = 60 * 60 * 1000;
const MIN_REMAINING_TTL_MS = 45 * 60 * 1000;
const MIN_REBUILD_GAP_MS = 45 * 60 * 1000;
const MIN_POST_AGE_BEFORE_REFRESH_MS = 45 * 60 * 1000;

const REBUILD_INTERVAL_HOURS = 1;
const SOURCE_CHECK_CYCLE_HOURS = 24;

const MIN_SOURCES_PER_COUNTRY_PER_RUN = 300;
const MAX_SOURCES_PER_COUNTRY_PER_RUN = 1600;
