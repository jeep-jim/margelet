...
const MAX_IMPORT_CANDIDATES_PER_SOURCE = 5;
const MAX_REFRESH_POSTS_PER_SOURCE = 1;
const MAX_RESCUE_IMPORTS_PER_EMPTY_SOURCE = 2;
const COUNTRY_RESCUE_FRESH_POSTS_THRESHOLD = 10;
...
const MIN_POST_AGE_BEFORE_REFRESH_MS = 2 * 60 * 60 * 1000;

const REBUILD_INTERVAL_HOURS = 1;
const SOURCE_CHECK_CYCLE_HOURS = 24;

const MIN_SOURCES_PER_COUNTRY_PER_RUN = 500;
const MAX_SOURCES_PER_COUNTRY_PER_RUN = 1800;
